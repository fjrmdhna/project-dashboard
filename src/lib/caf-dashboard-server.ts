...
export const CAF_DASHBOARD_COLUMNS =
  "caf_status, caf_type, approved_date, implemented_date, created_date, status_duration, project_name, vendor_tlp_name, vendor_requestor_name, avp, staff, caf_number, site_id_indosat, site_name, rfs_af, endorse_af, patp_accepted_af"

const SITE_DATA_CACHE_KEY = "caf-site-data:v3"
